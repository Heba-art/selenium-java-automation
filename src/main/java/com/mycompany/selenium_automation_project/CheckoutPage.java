...
public class CheckoutPage extends BasePage{
    ...
    public void clickContinue() {
        // This uses the powerful click method you inherited from BasePage
        clickWithRetry(continueBtn);
    }
...
//	}
	...
	public double getItemTotal() {
	    WebElement totalElement = wait.until(ExpectedConditions.visibilityOfElementLocated(itemTotalLabel));
	    String text = totalElement.getText().replace("Item total: $","").trim();
